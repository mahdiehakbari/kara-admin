...
const GroupMessage = () => {
  ...
  const hoverBorderClasses: Record<number, string> = {
    1: 'hover:border-violet-700',
    2: 'hover:border-(--primary)',
    3: 'hover:border-[#15803d]',
  };

  return (
    <div className='mx-8'>
      <h3 className='line-clamp-2 text-lg text-(--text-black) font-semibold mb-2'>
        ارسال در گروه‌های تلگرامی و واتس‌اپ
      </h3>
      <p className='text-(--text-muted) text-justify mb-6'>
        این متن‌ها طوری طراحی شده‌اند که حس «کمک کردن و دلسوزی» را منتقل کنند.
        آن‌ها را در گروه‌های خانوادگی، کانال‌های کاری یا گروه‌های مجتمع مسکونی
        خود کپی کنید تا افراد نیازمند به خدمات دندانپزشکی، شماره خود را به شما
        بدهند.
      </p>
      ...
      <div className='flex gap-2 border border-[#fef3c7] bg-[#fffbeb] p-4 rounded-2xl mt-6'>
        ...
        <div>
          ...
          <p className='text-yellow-700 text-[13px]'>
            هیچ‌گاه در پیام‌های خود به پاداش یا سود خودتان اشاره نکنید. تمرکز
            پیام باید ۱۰۰٪ روی حل مشکل دندان‌پزشکی شخص مقابل و مزایای فوق‌العاده
            بانک تجارت (۱۵۰ میلیون و اقساط ۱۲ ماهه) باشد.
          </p>
        </div>
      </div>
    </div>
